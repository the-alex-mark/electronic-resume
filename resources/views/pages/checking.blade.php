...
@section('page')
    <div class="container d-flex flex-grow-1">
        <form id="test" method="POST" enctype="multipart/form-data" action="{{ route('checking.save') }}" class="flex-grow-1 d-flex flex-column">
            @csrf

            <div id="accordion-test" class="accordion mb-2 question-list">
                @foreach($questions ?? [] as $index => $question)
                    @include('components.checking.question', array_merge($question, [
